...
export default function App() {
  return (
    <ThemeProvider>
      {/* Toast + Confirm đặt ở App level: vùng /share/* (ngoài đăng nhập) cũng
          dùng được, và DocumentsContext cần useToast() nên ToastProvider phải
          bọc NGOÀI DocumentsProvider. */}
      <ToastProvider>
        <ConfirmProvider>
          <AuthProvider>
            <Routes>
